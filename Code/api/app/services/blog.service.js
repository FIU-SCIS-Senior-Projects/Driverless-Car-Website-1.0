...
//     };
//     // BlogService.prototype.addTask = function (newTask) {
//     //     var headers = new http_1.Headers();
//     //     headers.append('Content-Type', 'application/json');
//     //     return this.http.post('/blog', JSON.stringify(newTask), { headers: headers })
//     //         .map(function (res) { return res.json(); });
//     // };
//     // BlogService.prototype.deleteTask = function (id) {
//     //     return this.http.delete('/blog/' + id)
//     //         .map(function (res) { return res.json(); });
//     // };
//     // BlogService.prototype.updateStatus = function (blog) {
//     //     var headers = new http_1.Headers();
//     //     headers.append('Content-Type', 'application/json');
